...
Formal architecture and design specifications. Generalization proofs and
ontology transfer tests extracted from the governor pattern and related
design work.
...
| `signed_is_not_witnessed.md` | Receipt-kind vocabulary and schema discipline for witnessed systems. Four receipt kinds (source / observation / custody / claim), required `cannot_testify` non-coverage declarations on observation receipts, and a forbidden-transitions table that prevents cryptographic integrity from being laundered into observation, custody, or claim authority. Applies existing admissibility doctrine (Authority, SurfaceAuthorization, Freshness, RecoveryMargin, WitnessInvariance, civic_migration_appliance, Signal Authority candidate) at the receipt schema boundary. Cross-corpus vocabulary for NQ / Wicket / Agent Governor / Labelwatch. |

## Related

- [Paper 15: Cybernetic Fault Domains](../preprint/15-cybernetic-fault-domains/) — governor pattern origin, enforcement kernel, R_t risk index
- [Paper 12: Bounded Lattice Inference](../preprint/12-bounded-lattice-inference/) — governed reasoning substrate with FSM authority
