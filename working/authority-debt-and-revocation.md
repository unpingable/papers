...
- **2026-05-07.** Origin in gnat-claude OS authority-substrate survey (sibling to the language-substrate gnat lab from 2026-05-06 → 2026-05-07). Chatty's "axis-resolution + post-survey refinement" pass locked the eight axes (with three splits) and identified the asymmetric promotion discipline. Survey finding 6 surfaced the keeper line; finding 7 surfaced the wire-native-authority companion sub-rule.
- **Multi-model lineage:** gnat-claude (survey + axis-locking), chatty (Q1/Q2/Q5 resolutions, 5a/5b post-survey split, asymmetric promotion discipline, paper-portable wording), claude-code-papers (this writeup, Lean-bridge cross-pointer, working-note staging).
