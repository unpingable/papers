...
- `~/git/lean/LeanProofs/Scratch/BoundaryTransit.lean` — direct `lake env lean` check clean (0 errors, exit 0). Status: **scratch-checked**. Not in `LeanProofs.lean` import surface.
