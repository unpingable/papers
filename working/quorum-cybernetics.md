...
**Lean sketch not lifted to disk.** Pointer for if/when a forcing case appears (e.g., paper draft needing the formalization, or binding-set-formation becoming load-bearing in adjacent work).
