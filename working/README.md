...
- **parked-leads.md** — *Parked Leads*: Register filed 2026-05-20 from the eight-slice brainstorm + audit. Records six candidate leads (Coverage Cannot Mint Absence / Receipt Envelope MVS / Serialized Authority Becomes Claim / Cartographer Aperture / Narrative Cannot Mint Authority / Specification Does Not Mint Object) that the audit refused to authorize as new construction, each with an explicit reopening predicate (new negative fixture / live repo consumer / cross-tool recurrence / contradiction not covered by existing kernel). Three buckets — warm (NQ/Wicket/AG/Nightshift pressure away from earning construction), cold (Cartographer Aperture — defer until two non-chat specimens), doctrine/methodology (essay/keeper-line layer, not kernel). Composes with [gate stack](../../.claude/projects/-home-jbeck-git-papers/memory/feedback-gate-stack.md) — every lead lives at *handle* stage. Load-bearing line: *"Not earned yet" is not "false." It is "don't let the name spend authority."* Anti-goblin-door policy compressed; refuses backlog-converts-to-obligation drift.
