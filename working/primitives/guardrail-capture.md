...
- Filed candidate / default-density per `feedback-note-density-subtypes.md`. Not rich-staging; not promoted. No Lean formalization yet because no precise, non-redundant theorem or countermodel has been selected. If one is selected with explicit model, overlap, and non-vacuity controls, formalization may lead any later runtime case.
