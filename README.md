...
This repository contains technical writing, diagnostic frameworks, and specification documents related to AI systems, governance, and temporal dynamics in complex systems.

## Structure

- `preprint/` — numbered research papers published on [Zenodo](https://zenodo.org/) as part of the Δt framework series
