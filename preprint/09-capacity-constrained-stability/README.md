...
## Citation
```bibtex
@article{rock2025institutional-failure,
  author = {Beck, James},
  title = {Capacity-Constrained Stability: A Control-Theoretic Framework for Institutional Resilience},
  year = {2025},
  doi = {10.5281/zenodo.18019050},
  url = {https://zenodo.org/records/18019051}
}
```
