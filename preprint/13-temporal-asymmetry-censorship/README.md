...
The analysis is presented from a defender and systems-design perspective, emphasizing structural properties rather than operational exploitation. The framework is intended for researchers and practitioners studying censorship resistance, network security, and control-theoretic failure modes in asynchronous systems.


## Key Contributions

- From these primitives, we derive the Universal Bypass Inequality, a formal condition under which censorship cannot succeed without exceeding computational, temporal, or political budgets.
- The Universal Bypass Inequality Synthesizing the three families, we derive a necessary and sufficient condition for successful bypass.
- No empirical validation: We present formal framework, not measurements of production systems.

## Citation
```bibtex
@article{rock2026cybernetics,
  author = {Beck, James},
  title = {Temporal Asymmetry in Censorship Systems},
  year = {2026},
  doi = {10.5281/zenodo.18235696},
  url = {https://zenodo.org/records/18235697}
}
```
