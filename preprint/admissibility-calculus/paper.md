...
> **Scope: Axis 1 of the admissibility suite.** The full admissibility calculus is a suite of axis kernels, not a single paper. Axis 1 (this note) covers safety / value preservation. Axis 2 (composition / merge admissibility) and Axis 3 (self-amendment / frontier mutation) are open and will be drafted as separate kernel notes; the unifying calculus paper synthesizes them only after the axes exist and cross-axis theorems force unification. See `working/calculus-suite-map.md` for the suite plan.
>
