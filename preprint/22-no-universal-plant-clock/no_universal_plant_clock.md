...
Many coordination failures are temporal failures wearing other labels. The four-layer model and ratio analysis provide the vocabulary to strip the label and name the constraint.
