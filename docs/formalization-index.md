...
#### Formalization warrant (filed 2026-06-11) — name-early, NOT authorized to build

This warrant is a handle for review, not a build order. It is queued **behind the demo/slab**, not a pre-launch move.
...
- **Disposition:** warrant filed; spike *after* the slab; full formalization only if the spike says the narrowed claim is worth a real campaign. Refute before certify — highest assurance-per-hour ordering for a nec-and-suff claim.
